// Firebase-конфигурация проекта MarketPoint
...
export {
  RecaptchaVerifier, signInWithPhoneNumber, signInWithEmailAndPassword, signOut, createUserWithEmailAndPassword,
  collection, doc, getDoc, setDoc, addDoc, updateDoc, deleteDoc, getDocs, query, where, orderBy, limit, serverTimestamp,
  ref, uploadBytes, getDownloadURL, initializeApp, getApps, getApp
};
